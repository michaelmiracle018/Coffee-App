...
const PaymentScreen = () => {
  const { amount } = useLocalSearchParams<{ amount: string | any }>();
            ...
            <View
              ...
              <View style={styles.CreditCardBG}>
                <LinearGradient
                  ...
                  <MaterialCommunityIcons name="chip" size={24} color={COLORS.primaryOrangeHex} />
                  <FontAwesome name="cc-visa" size={24} color={COLORS.primaryWhiteHex} />
                  </View>
